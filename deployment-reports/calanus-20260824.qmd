---
title: "Glider Deployment Report: calanus (August 28, 2026)"
format: 
  pdf: 
    toc: true
    colorlinks: true
...
glider_name <- "calanus" 
glider_serial <- "1029" 
deployment <-"calanus-20260824"
deployment_year <- "2026"
deployment_date <- "August 24, 2026"
...
So far the glider is flying well, the issues we were running into yesterday are ongoing but they are related to the camera log files and its taking photos as expected. The only thing you would see as a pilot is science_super oddities racking up (+1 per segment) and maybe a line that pops up as 'bad science line' or something similar. It has no effect on the gliders flight. The other issue was related to the SFMC not sending data files but we think that is also resolved by sending two of each data file at the surface (2 tcd and 2 scd). 
