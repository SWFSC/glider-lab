...
sampling %>%
  reframe(
    `Date` = c(rep(c("2025-04-14","2025-04-15","2025-04-16","2025-04-17","2025-04-18","2025-04-19","2025-04-20"),times=c(4,3,2,2,2,1,4))),
    `Time (GMT)` = c(rep(c("17:57:07","16:28:11","16:51:30","20:24:00","18:23:48","16:23:06","19:52:12"),times=c(4,3,2,2,2,1,4))),
    `Sensor` = c("CTD","ECO Puck","Oxygen optode","PAR","Oxygen optode","ECO Puck","PAR","CTD","ECO Puck","ECO Puck","Oxygen optode","Oxygen optode","PAR","PAR","CTD","ECO Puck","Oxygen Optode","PAR"),
    `On/Off` = c("On","On","On","On","Off","Off","Off","Off","On","Off","On","Off","On","Off","On","On","On","On")
    ) %>%
  knitr::kable(digits = c(0, 0, 0, 0, 2))
```
