...
eng.ts<-file.path(base.path,deployment,"data","processed-L1",paste0(deployment,"-delayed-eng.nc"))
sci.ts<-file.path(base.path,deployment,"data","processed-L1",paste0(deployment,"-delayed-sci.nc"))
