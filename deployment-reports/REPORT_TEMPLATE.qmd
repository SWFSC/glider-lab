...
listaacfg<-list.files(here(base.path,deployment,"file-archive"),pattern="*_ad2cp.cfg")
listaacfg<-list.files(here(base.path,deployment,"file-archive"),pattern="*_azfp.cfg")
listsgcfg<-list.files(here(base.path,deployment,"file-archive"),pattern="*_solocam.cfg")
