...
# TODO
# save total number of photos captured and free disk space from .cam files 

```

**UPDATE FOR SHADOWGRAPH DEPLOYMENTS**  The shadowgraph camera was programmed to take photos every `{r} photo_freq` seconds on dives and climbs, with a XX% red flash brightness. After `{r} num_photos` the shadowgraph **FILL IN... restarts/reboots?**. During the deployment, the shadowgraph camera took XX photos and used XX% of the camera storage (XX.X GB). 
